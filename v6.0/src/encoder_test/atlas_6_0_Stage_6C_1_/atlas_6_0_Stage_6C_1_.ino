...
void printConfig() {
  Serial.println("CONFIG;VERSION=ATLAS_STAGE6C_V2_LEFT_DIRECTION_FIX");
  ...
  Serial.println("CONFIG;LEFT_MOTOR_INVERTED=YES;RIGHT_MOTOR_INVERTED=NO");
...
void setup() {
  ...
  Serial.println();
  Serial.println("ATLAS_STAGE6C_V2_LEFT_DIRECTION_FIX_READY");
