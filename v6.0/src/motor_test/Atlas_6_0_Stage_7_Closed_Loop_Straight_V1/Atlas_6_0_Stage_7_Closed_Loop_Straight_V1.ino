...
// 左轮平均约领先 1.64%。V1 先采用保守的“只提升落后轮”比例控制。
constexpr unsigned long SYNC_CONTROL_INTERVAL_MS = 50;
constexpr unsigned long SYNC_REPORT_INTERVAL_MS  = 200;
constexpr unsigned long SYNC_START_DELAY_MS      = 150;
constexpr int SYNC_MAX_BASE_PWM                   = 180;
constexpr float SYNC_KP_PWM_PER_EQUIV_PULSE       = 0.20f;
constexpr float SYNC_DEADBAND_EQUIV_PULSES        = 6.0f;
constexpr int SYNC_MAX_BOOST_PWM                  = 12;
constexpr int SYNC_MAX_PWM_STEP                   = 2;
...
void printConfig() {
  ...
  Serial.println("version         : Atlas 7 closed-loop straight v1");
...
void setup() {
  ...
  Serial.println();
  Serial.println("========================================");
  Serial.println("Atlas 7 closed-loop straight v1 is ready");
