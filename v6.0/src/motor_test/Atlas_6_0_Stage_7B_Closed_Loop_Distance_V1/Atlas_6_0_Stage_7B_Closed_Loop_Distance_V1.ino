...
// ============================================================
// Atlas 6.0 Stage 7B Closed-Loop Distance V1
...
void printConfig() {
  ...
  Serial.println("version         : Atlas 7B closed-loop distance v1");
  ...
  Serial.println("new FDS         : synchronized 80 PWM target-distance test");
}
...
void startTargetMotion(
  ...
  if (targetSyncEnabled) {
    ...
    Serial.println("stop rule       : each wheel stops independently at its own target");
  }
}
...
void setup() {
  ...
  Serial.println();
  Serial.println("========================================");
  Serial.println("Atlas 7B closed-loop distance v1 is ready");
