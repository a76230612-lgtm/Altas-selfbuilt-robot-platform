...
// ============================================================
// Atlas 6.0 Stage 7 Closed-Loop Straight V2
...
void printConfig() {
  ...
  Serial.println("version         : Atlas 7 closed-loop straight v2");
...
void setup() {
  ...
  Serial.println();
  Serial.println("========================================");
  Serial.println("Atlas 7 closed-loop straight v2 is ready");
