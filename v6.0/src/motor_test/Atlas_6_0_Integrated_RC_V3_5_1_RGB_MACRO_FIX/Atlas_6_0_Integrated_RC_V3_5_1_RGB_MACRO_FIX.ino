/*
  Atlas 6.0 - Integrated Release Candidate V3.5.1 RGB MACRO FIX
...
static const uint8_t ATLAS_RGB_BRIGHTNESS=45; // intentionally limited for power and glare
...
void setup(){
  ...
  rgb.begin();
  rgb.setBrightness(ATLAS_RGB_BRIGHTNESS);
  rgb.clear();
  rgb.show();
  ...
  Serial.println();
  Serial.println("================================================");
  Serial.println("ATLAS 6.0 INTEGRATED RELEASE CANDIDATE V3.5.1 RGB MACRO FIX");
  Serial.println("================================================");
  ...
  Serial.println("BUILD,V3.5.1,RGB_MACRO_FIX");
